...
const CorporateBanner = () => {
  return (
    <main className="m-0 p-0 w-full h-[255px] relative lg:w-full lg:h-[564px] ">
      <div className="w-full absolute bg-white subpixel-antialiased flex flex-1 justify-between items-center h-[80px] p-2  mt-[27px] text-left 
       lg:h-[140px] ">
        <div className="m-1">
        <p className="text-[10px] w-full lg:text-[15px]">PERFECT</p>
        <h2 className="w-full text-[15px] lg:text-[25px]">Corporate Gifting</h2>
